...
from profiles.models import SLCPyUser

class SLCPyUserCreationForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        user = super(SLCPyUserCreationForm, 
...
class SLCPyUserChangeForm(forms.ModelForm):
...
class SLCPyUserAdmin(UserAdmin):
    # Set the add/modify forms
    add_form = SLCPyUserCreationForm
    form = SLCPyUserChangeForm
...
# Register the new SLCPyUserAdmin
admin.site.register(SLCPyUser, SLCPyUserAdmin)
